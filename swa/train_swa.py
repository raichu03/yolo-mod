...
if __name__ == "__main__":
    ...
    parser.add_argument("--base_epoch", type=int, default=300, help="Base epoch for SWA")
    parser.add_argument("--batch_size", type=int, default=258, help="Batch size for training")
